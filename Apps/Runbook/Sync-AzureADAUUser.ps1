...
.PARAMETER UPNMatch
    This parameter is used to specify the positive match of the UPN using blob matching (powershell wildcard matching e.g. -like).
...
.PARAMETER UPNNegativeMatch
    This parameter is used to specify the negative match of the UPN using blob matching (powershell wildcard matching e.g. -NotLike).
    A negative match will override a positive match.
...
.EXAMPLE
    PS C:\> Sync-AzureADAUUser.ps1 -AdminUnitID "00000000-0000-0000-0000-000000000000" -UPNMatch "*@example.com" -UPNNegativeMatch "*priv*"
